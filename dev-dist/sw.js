...
define(['./workbox-13942bd7'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.origin === HYMIZE_ORIGIN && url.pathname === "/api", new workbox.NetworkFirst({
  ...
  workbox.registerRoute(({
    url
  }) => url.origin === HYMIZE_ORIGIN && url.pathname.startsWith("/api/hymns/") && url.pathname.endsWith("/indexes"), new workbox.NetworkFirst({
  ...
  workbox.registerRoute(({
    url
  }) => url.origin === HYMIZE_ORIGIN && /^\/api\/hymns\/[^/]+\/[^/]+\/[^/]+\/hymn\/\d+$/.test(url.pathname), new workbox.NetworkFirst({
